  ...
  return (
    <>
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        ...
        <div className="absolute bottom-0 right-0 w-[200px] h-[200px] md:w-[500px] md:h-[500px] bg-primary/5 rounded-full blur-2xl md:blur-[100px] opacity-40 transition-all duration-700"></div>
      </div>

      <div className="relative z-10 flex flex-col min-h-screen">
        <Header />
        <main className="max-w-6xl grow container mx-auto px-4 sm:px-8 lg:px-10 py-12 lg:py-20 flex flex-col gap-24">
          <Hero />
          <TechStack />
          <Projects />
          <Contact />
